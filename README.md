...
<title>TOONSWOOD.COM</title>
<link rel="icon" type="image/png" href="https://www.toonswood.com/favicon.ico"/>
...
<style>
body {
    font-family: 'Open Sans', sans-serif;font-weight:900;font-size:18px;background-color:#070d45;color:white
}
hr{color:#aaaaaa}
/* Style buttons */
.btn {
...
<body><br/>
<center><img class="w3-image" src="https://i.postimg.cc/XJXFYDyP/Pics-Art-10-22-05-00-17.png" alt="Toonswood.Com" width="100%" height="auto"/><br/><iframe data-aa="1428492" src="//ad.a-ads.com/1428492?size=320x50" scrolling="no" style="width:320px; height:50px; border:0px; padding:0; overflow:hidden" allowtransparency="true"></iframe></center>
  <hr/>
<center><h4><b>Watch Online</b></h4></center>
<hr/>
    <center><h4><b>Google Drive</b></h4></center>
<hr/>
<script type="text/javascript">
d.write('<div class="resp-container"> <iframe class="resp-iframe" src="https://drive.google.com/file/d/'+iframe+'/preview" gesture="media" allow="encrypted-media" allowfullscreen="" mozallowfullscreen="true" webkitallowfullscreen="true" sandboxscrolling="no" sandbox="allow-scripts allow-same-origin"></iframe></div><hr/><center><a href="https://www.toonshub.ml/" rel="noopener noreferrer" target="_blank"><button class="btn-hover color-10">Visit ToonsHub</button></a></center><br/>')
</script><center><script type="text/javascript" src="https://uprimp.com/bnr.php?section=Ads&pub=627432&format=300x250&ga=g"></script>
<noscript><a href="<iframe data-aa="1428492" src="//ad.a-ads.com/1428492?size=320x50" scrolling="no" style="width:320px; height:50px; border:0px; padding:0; overflow:hidden" allowtransparency="true"></iframe>" alt="A-Ads " /></a></noscript></center></body>
</html>
